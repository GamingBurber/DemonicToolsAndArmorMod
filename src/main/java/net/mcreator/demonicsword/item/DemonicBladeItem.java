...
public class DemonicBladeItem extends DemonicSwordModElements.ModElement {
	@ObjectHolder("demonic_sword:demonic_blade")
	public static final Item block = null;
	public DemonicBladeItem(DemonicSwordModElements instance) {
		super(instance, 7);
	}
